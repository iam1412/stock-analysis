...
| W16 | error | P/S = Market Cap ÷ รายได้ที่พิมพ์ | **warn ไม่ใช่ error เพราะเป็นค่าเดียวในชุดนี้ที่อ้างอิงข้ามการ์ด** — ตัวตั้งมาจากการ์ด Market Cap ไม่ใช่บรรทัด `.d` ของตัวเอง ⇒ ถ้ามีรายงานที่ฐานรายได้/ฐานหุ้นคนละชุด error จะบล็อก cron ทั้งที่ตัวซ่อมแก้ให้ไม่ได้ · ตรวจเฉพาะการ์ดที่ `.d` ประกาศ "รายได้/revenue/sales" พร้อมจำนวนเงิน (คลังมี 8 การ์ด — ตรวจมือครบทั้ง 8 = ของค้างจากราคาจริงทุกใบ: SNOW 17x→24x · VGI 4.3x→5.2x · MBLY 4.0x→3.7x) · ข้าม EV/Sales (ต้องใช้หนี้สุทธิ ไม่มีฐานให้อ่าน) และป้ายเชิงประวัติ ("P/S มัธยฐานของตัวเอง" — PAAS) · เงียบเมื่ออ่านฐาน Market Cap ไม่ได้ |
