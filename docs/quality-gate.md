...
> ⚠️ **ผลข้างเคียงที่ตั้งใจ: `W05` (FV ≠ ค่าเฉลี่ยวิธี) จะเตือนทุกใบที่ใช้กฎนี้** เพราะ W05 ตั้งสมมติฐานว่า FV = ค่าเฉลี่ยของทุกขา ซึ่งกฎ 0.4c ยกเลิกโดยเจตนา · **เป็น warning ที่ถูกต้อง อย่า \"แก้\" ด้วยการกลับไปเฉลี่ย** — ให้ระบุในย่อหน้า full-disclosure ว่าใช้ 0.4c · ถ้าจะแก้ให้ W05 เงียบ ต้องแก้ `test/check-reports.js` ให้ยอมรับกรณี dispersion >2.0 พร้อมเพิ่มเคสใน `test/self-test.js` ตาม CLAUDE.md §8
