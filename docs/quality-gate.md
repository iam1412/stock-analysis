...
| W22 | warn | ค่าเดียวกันคนละที่ไม่ตรงกัน (manifest pair) | คู่ **consistency** ที่ `pair` ประกาศไว้: fairLine/legend/mFair/การ์ดโซนสะสม/vcell กรอบ ↔ FV · ป้าย gauge mCur ↔ `.px` · วันที่ disclaimer/วงเล็บ ↔ วันที่ราคา · `stock-meta.roe` ต้อง null เมื่อ EPS ฐาน ≤0 · ยิงบนใบสุขภาพดี = บั๊กจริง (ไม่ใช่ของค้าง) — ยิงตอนเพิ่ม 180 ใบ · **ยังไม่มี healer** จึงเป็น warn (ระยะ 2 จะยก) |
