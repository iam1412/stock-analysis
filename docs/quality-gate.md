...
| W05 | warn | FV ≈ ค่าเฉลี่ยวิธีที่แสดง (รู้จักกฎ 0.4c ตั้งแต่ 18 ส.ค. 69) | การ์ดที่ `.mname` มีคำว่า "บริบท"/"ไม่รวม" **ไม่เข้าเฉลี่ย** · ขาที่เหลือห่างกัน ≤2.0× และเครื่องหมายเดียวกัน → FV ต้อง ≈ ค่าเฉลี่ย ±7% (ทางเดิม) · ห่างกัน >2.0× หรือคนละเครื่องหมาย → **ห้ามเฉลี่ยตรง** FV ต้อง = ขาใดขาหนึ่ง (±3%) หรือค่าเฉลี่ยของกลุ่มย่อยที่ห่างกัน ≤2.0× (±7%) ไม่งั้นยิงพร้อมบอกกฎ 0.4c · แก้: ตั้งชื่อการ์ดบริบทให้มีคำว่า "บริบท" หรือเลือก headline ตาม 0.4c — **ห้ามแก้ด้วยการกลับไปเฉลี่ยรวม** |
