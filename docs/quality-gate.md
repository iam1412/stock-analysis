...
- **เคสอ้างอิง:** `MC` เฉลี่ย 3 ขา (P/E ฿11.96 · DDM ฿14.61 · Justified P/BV ฿12.81) = ฿13.13 ทั้งที่ 2 ขาหลังเป็นตระกูลเดียว — ถ้าถ่วงตามตระกูลจะได้ ฿13.29 (MOS 10.1% → ~11.2%, โซนเดียวกัน จึงไม่รันใหม่) · `SPC` ในเวฟเดียวกันทำถูก คือกัน Justified P/BV ไว้เป็นบริบท
