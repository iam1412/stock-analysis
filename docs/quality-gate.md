...
> ✅ **`W05` รู้จักกฎนี้แล้ว (18 ส.ค. 2569 — เดิมเตือนทุกใบที่ใช้ 0.4c เพราะสมมติว่า FV = ค่าเฉลี่ยทุกขา)**: การ์ดที่ชื่อมีคำว่า **"บริบท"/"ไม่รวม"** ไม่เข้าเฉลี่ย · ขาที่เหลือห่าง >2.0× หรือคนละเครื่องหมาย ⇒ ผ่านเมื่อ FV = ขาเดียว (±3%) หรือค่าเฉลี่ยกลุ่มย่อย ≤2.0× (ข้อ 3) · ⇒ **W05 ที่ยังยิงหลังวันนี้ = ละเมิด 0.4c จริง** (FV เป็นค่ากลางของขาที่ห้ามเฉลี่ย — กวาด 18 ส.ค. เจอ 14 ใบเก่าแบบนี้ เช่น AWC BAY CHG SAWAD ระยะ 2.0–5.2×) หรือขาห่าง ≤2× แต่ FV ไม่ตรงค่าเฉลี่ย (0.4c-bis ถ่วงตระกูลปกติคลาด <7% จึงไม่ยิง) · **อย่า "แก้" ด้วยการกลับไปเฉลี่ยรวม** — เลือก headline/กลุ่มย่อยตามข้อ 1–3 · เคสตัวอย่างที่เงียบถูกต้อง: `CRWV` (ขา NPV ติดลบเป็นบริบท) · `NTRA` · `TSEM` (FV = ขา P/E ทั้งที่ DCF ห่าง 2.2×)
