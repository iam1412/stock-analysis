...
## 13. คำถามเปิด (ตัดสินตอนเขียน plan / ถามเจ้าของ)

1. commit ของ migration: ยกเว้นกฎ "1 commit = 1 หุ้น" เป็นต่อแบตช์ได้ไหม (§11 P6)
2. แคตตาล็อกการ์ด section 1: จำนวนคีย์สุดท้าย + ชื่อไทยมาตรฐาน — ร่างจาก label 1,526 แบบแล้วให้เจ้าของดู
3. DCF สูตรมาตรฐาน 2-stage พอไหม หรือต้องมี 3-stage (ดูจาก 232 ใบ DCF ตอน migrate — ถ้า >10% ไม่ลง ต้องเพิ่ม)
