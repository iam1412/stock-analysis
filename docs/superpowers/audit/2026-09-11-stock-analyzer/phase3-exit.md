...
_ยังเติมผลไม่ได้ — ต้องรอรอบ cron แรกที่เวลาใหม่รันจริง (คาด 16 ก.ย. 69) แล้วนับ "ข้าม — ตลาดยังเปิด" + ยืนยันว่าหุ้นไทย (.BK) อยู่ในรายการ patch จริง (ก่อนแก้ = 230–234 ครั้ง/วัน) ⇒ open-item #33 ยังเปิดอยู่จนกว่าจะวัดได้_
