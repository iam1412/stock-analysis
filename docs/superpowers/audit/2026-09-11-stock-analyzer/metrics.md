...
| regex ถอดค่า = 0 ใน cron/gate (ทาง v2) | cron/gate อ่าน-เขียนค่าจาก HTML ทุกช่อง | **`v2-path-test` 355/355** — ถ้อยคำตาม **ruling Task 12 R5**: ค่าของช่องสำเนามาจาก JSON · cron ไม่เขียนช่องสำเนาด้วย regex · regex ที่เหลือ (pass derived · tripwire วันที่ · คู่ manifest) เป็น **ตัวตรวจความสอดคล้อง** ไม่ใช่วิธีตัดสินค่า | `node test/v2-path-test.js` |
