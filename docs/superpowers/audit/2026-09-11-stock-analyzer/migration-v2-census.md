...
อัปเดต: 14/9/2569 18:21:37 (Asia/Bangkok)

| ผล | ใบ |
|---|---|
| ย้ายได้ | 578 |
| ยังไม่ได้ (residue) | 22 |
| รวม | 600 |
...
| site | ใบ | ตัวอย่าง (≤10) |
|---|---|---|
| psCard — ไม่มีการ์ดที่ตัดสินได้ | 575 | A AAI AAON AAPL ABBNY ABBV ABNB ABT ACE ACMR … |
| yieldCard — รูปตัวเลขต่าง ("N%" ≠ "N%") | 345 | A AAON AAPL ABBNY ABBV ABT ACN ADI ADM ADP … |
| peCard — ไม่มีการ์ดที่ตัดสินได้ | 289 | A AAOI ABNB ABT ACE ADP ADVANC ADVICE AEE AEHR … |
| pbvCard — ไม่มีการ์ดที่ตัดสินได้ | 256 | AAOI AAPL ABBNY ABBV ACE ACMR ACN ADBE ADI ADP … |
| yieldCard — ไม่มีการ์ดที่ตัดสินได้ | 171 | AAOI ABNB ACE ACMR ADBE ADSK AEHR AEVA AIG AKAM … |
| mcapCard — รูปตัวเลขต่าง ("$NB" ≠ "$NB") | 164 | AAON ABBNY ABBV ABNB ACMR ACN ADBE ADP AEE AIT … |
| scnNote — ไม่พบ | 163 | AAOI AAPL ABNB ACMR ACN ADBE ADI ADSK AEHR AEVA … |
| pbvCard — รูปตัวเลขต่าง ("N" ≠ "N") | 101 | A AAON ABNB ABT AEP AME AMGN AON AOS APD … |
| peCard — รูปตัวเลขต่าง ("N" ≠ "N") | 95 | AAPL ABBNY ACMR ACN ADI ADSK AMAT AMD ANET AOT … |
| scn | 86 | AAI ADM ADVICE AEE AEONTS AFL AIG AMATAV AME AON … |
| tgtCard — ไม่พบรูป "เป้า (+%)" | 75 | AAOI AAPL ABBNY ACMR ACN ADBE ADI ADSK AEHR ALAB … |
| zone — ราคาโซนสะสม N ≠ FV N (ผู้เขียนตั้งเอง) | 71 | AAOI ACMR ACN ADBE ADI ADSK ALAB AMKR ANET APH … |
| mcapCard — รูปตัวเลขต่าง ("฿N ล้าน" ≠ "฿N พันล้าน") | 38 | AAI AHC ANI APURE ASIAN ASK ASW BAFS BBIK BE8 … |
| mcapCard — ไม่มีการ์ดที่ตัดสินได้ | 24 | ARM ASML AVGO BIDU BNS BRK-B CB DB DEO EPD … |
| mcapCard — รูปตัวเลขต่าง ("฿N ล้าน" ≠ "฿N หมื่นล้าน") | 23 | ACE AURA AWC AYUD BAM BCH BKI BLA CHG CK … |
| mcapCard — รูปตัวเลขต่าง ("฿N พันล้าน" ≠ "฿N หมื่นล้าน") | 17 | AP BCP BCPG BEM BGRIM CBG CENTEL EGCO EPG GLOBAL … |
...
| mcapCard — รูปตัวเลขต่าง ("$NM" ≠ "$NM") | 1 | PDYN |
...
| ชนิด | จุด (คอลัมน์) | ใบ |
|---|---|---|
| รูปเลขเปลี่ยนแต่ค่าเท่าเดิม (form) | 262 | — |
| ค่าจริงขยับ (value) | 59 | 39 |
...
|---|---|---|---|
| ค่าต่างที่มีอยู่ก่อน patch (migration ยอมรับ) | 22 | 0.99% | AEE ANI BF-B BWXT CBOE CHAYO CMS DD DUK EPG EQIX EXE FDS GLOBAL HSY IIG IVL JAZZ LDOS LPH MFC MMS |
