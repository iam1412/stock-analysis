...
อัปเดต: 14/9/2569 18:25:38 (Asia/Bangkok)
...
| site | ใบ | ตัวอย่าง (≤10) |
|---|---|---|
| psCard — ไม่มีการ์ดที่ตัดสินได้ | 858 | A AAI AAON AAPL ABBNY ABBV ABNB ABT ACE ACMR … |
| yieldCard — รูปตัวเลขต่าง ("N%" ≠ "N%") | 510 | A AAON AAPL ABBNY ABBV ABT ACN ADI ADM ADP … |
| peCard — ไม่มีการ์ดที่ตัดสินได้ | 426 | A AAOI ABNB ABT ACE ADP ADVANC ADVICE AEE AEHR … |
| pbvCard — ไม่มีการ์ดที่ตัดสินได้ | 365 | AAOI AAPL ABBNY ABBV ACE ACMR ACN ADBE ADI ADP … |
| yieldCard — ไม่มีการ์ดที่ตัดสินได้ | 251 | AAOI ABNB ACE ACMR ADBE ADSK AEHR AEVA AIG AKAM … |
| scnNote — ไม่พบ | 224 | AAOI AAPL ABNB ACMR ACN ADBE ADI ADSK AEHR AEVA … |
| mcapCard — รูปตัวเลขต่าง ("$NB" ≠ "$NB") | 222 | AAON ABBNY ABBV ABNB ACMR ACN ADBE ADP AEE AIT … |
| pbvCard — รูปตัวเลขต่าง ("N" ≠ "N") | 147 | A AAON ABNB ABT AEP AME AMGN AON AOS APD … |
| scn | 140 | AAI ADM ADVICE AEE AEONTS AFL AIG AMATAV AME AON … |
| peCard — รูปตัวเลขต่าง ("N" ≠ "N") | 137 | AAPL ABBNY ACMR ACN ADI ADSK AMAT AMD ANET AOT … |
| tgtCard — ไม่พบรูป "เป้า (+%)" | 99 | AAOI AAPL ABBNY ACMR ACN ADBE ADI ADSK AEHR ALAB … |
| zone — ราคาโซนสะสม N ≠ FV N (ผู้เขียนตั้งเอง) | 94 | AAOI ACMR ACN ADBE ADI ADSK ALAB AMKR ANET APH … |
...
| ชนิด | จุด (คอลัมน์) | ใบ |
|---|---|---|
| รูปเลขเปลี่ยนแต่ค่าเท่าเดิม (form) | 369 | — |
