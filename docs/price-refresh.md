...
- **%/ปี รักษาสูตรของใบนั้น** — 795 คอลัมน์ใช้ CAGR · 19 คอลัมน์ใช้ `total/N` ⇒ เลือกสูตรที่ใกล้ค่าที่โชว์ที่สุด
  (ไม่ "อัปเกรด" linear เป็น CAGR — นั่นคือแก้เนื้อหา ไม่ใช่ซ่อมค่าค้าง) · ตัวตั้งคือ total **ที่จะถูกเขียนจริง**
  (ปัดแล้ว) ไม่ใช่ค่าดิบ ไม่งั้นรอบหน้าอ่านค่าที่เขียนไปแล้วได้คนละคำตอบ → เขียนซ้ำทุกวัน
