...
| `mos-sign-flip` | MOS พลิกเครื่องหมาย **เกิน dead-band ±5 จุด (ระยะ 1)** (2026-08-02: flip ที่ทั้งเก่า-ใหม่อยู่ใน ±5 จุด = แกว่งรอบ FV → patch ผ่าน patcher เขียนเครื่องหมายใหม่เอง — ±5 ตรง dead-band ของ gate W06 ดังนั้น prose "ถูก/แพงเล็กน้อย" ไม่ขัด gate) |
