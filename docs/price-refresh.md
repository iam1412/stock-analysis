...
- **ปันผล % / P/BV** (11 ก.ย. 69 — W19/W20 · ก่อนหน้านี้ cron ไม่มีโค้ดส่วนนี้เลย ⇒ ลอยตามราคาทั้งคลัง: FDS ปันผล 1.86% จริง 1.76% · P/BV 4.40x จริง 4.63x):
...
โชว์ +8.7% ทั้งที่ของจริง −11.3% (กลับความหมายของฉาก "กรณีเลวร้ายสุด" ไปเลย)
