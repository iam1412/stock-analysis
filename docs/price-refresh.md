...
P/E และ % ของราคาเป้าไม่ใช่ข้อเท็จจริงของบริษัท แต่เป็น **ราคาปัจจุบัน ÷ / − ข้อเท็จจริงที่รายงานพิมพ์ไว้เอง**
(EPS ในบรรทัด `.d` ของการ์ดนั้น · ราคาเป้าในช่องค่า) ⇒ ราคาขยับทุกวันแต่ค่าพวกนี้ไม่ขยับ = หน้าเว็บโชว์ตัวเลขที่ขัดกันเอง
**วัดก่อนแก้ (19 ส.ค. 69): P/E ไม่ตรง 233/908 ใบ · % ในการ์ดเป้าไม่ตรง 81/109 ใบที่เขียน % ไว้ — `npm test` เขียวทุกใบ**
