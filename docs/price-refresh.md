...
| `stock-meta` price/mos/upside (คีย์อื่นคงเดิม ยกเว้น `pe` — ดูแถวล่าง) | E29–E31 |
...
- **P/S**: ตัวตั้งมาจากการ์ด Market Cap (ข้ามการ์ด) ⇒ ตัวตรวจเป็น **W16 ระดับ warn** ไม่ใช่ error — ตัวซ่อมยังเขียนให้ตามปกติเมื่ออ่านฐานได้
...
node tools/update-prices.js --heal-derived --write          # ซ่อมการ์ด + stock-meta.pe
