...
> **v2 = รูปแบบที่ใช้จริงแล้วทั้งคลัง** (ย้ายเสร็จ 14 ก.ย. 2569 · ระยะ 2 ส่วน E): **865/908 ใบเป็น v2** · เหลือ **43 ใบเป็น v1** (residue ที่ migrator ไม่ย้ายเพราะตัวเลขในใบขัดกันเอง — รายชื่อ/ชนิดอยู่ใน `docs/superpowers/audit/2026-09-11-stock-analyzer/phase2-exit.md` · แก้ต้นเหตุแล้วย้ายซ้ำเป็นงานระยะ 3) · **โหมด NEW ทุกใบใหม่เริ่มจาก skeleton v2** (ระยะ 2 ส่วน B) — ตัวอย่างข้างล่างนี้จึงเป็น v2 ตามที่ skeleton ใช้จริง · โหมด UPDATE บนไฟล์ v1 ที่เหลือ อ่านรูปแบบจากไฟล์จริงตรง ๆ (SKILL STEP 5B ข้อ 1) ไม่ต้องอิงตัวอย่างนี้
