...
- **จำนวนเทสที่ปิดงาน** — market 27 · io 31 · cron 63 (77 หลัง fix round final) · sidecar 57 · scanners-cron 21 · queue-test 559 · update-prices-test 520 · `verify:cron` มี `check-v3` (จำนวนขั้นอยู่ใน marker ของ CLAUDE.md §8 — ห้ามเขียนเลขนอก marker)
