...
- **กฎอยู่ที่ CLAUDE.md ที่เดียว** — ไฟล์นี้ไม่ใช่กฎ เป็นเหตุผลว่า "ทำไมกฎเป็นแบบนี้" ไว้กันการเถียงซ้ำ · ถ้าขัดกัน CLAUDE.md ชนะ
...
กฎฉบับใช้งานอยู่ที่ `CLAUDE.md` §3.2 · ย่อหน้านี้เก็บไว้เพราะมีทั้งวันที่วัดจริงและที่มาของการแก้กติกา
...
*ข้อความนี้ ณ 21 ก.ย. 69 — กฎปัจจุบันดูที่ `CLAUDE.md` §3.2 (ถ้าขัดกัน CLAUDE.md ชนะ)*
...
กฎฉบับใช้งานอยู่ที่ `CLAUDE.md` §9 (cron patch อะไร / ไม่แตะอะไร / freeze เมื่อไหร่) · ย่อหน้านี้เก็บ **วันที่ที่เริ่มแตะแต่ละอย่าง · เลข open-item · ระยะของ audit · สถิติ ณ วันนั้น** ที่ถอดออกไป
...
*ข้อความนี้ ณ 21 ก.ย. 69 — กฎปัจจุบันดูที่ `CLAUDE.md` §9 (ถ้าขัดกัน CLAUDE.md ชนะ)*
