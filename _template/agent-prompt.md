...
- **ปีในวันที่ที่ตัวเองประทับ = พ.ศ. เสมอ ทั้งหุ้นไทยและ US** (CLAUDE.md §7): footer "ข้อมูล ณ 22 ก.ย. **2569**" · `values.dateEra` = `"BE"` — **ห้ามใช้ ค.ศ.** · ปีงบ/ปีของเหตุการณ์ในเนื้อหา (FY2026, Q3 2026) เขียนตามแหล่งได้ — กฎนี้คุมเฉพาะวันที่ของรายงานเอง
