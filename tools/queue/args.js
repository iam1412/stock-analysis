'use strict';
const VALUE_FLAGS = new Set(['--mode', '--model', '--brand', '--median-spec', '--tags', '--message', '--age', '--light-rule', '--migrate']);   // --migrate "SYM SYM…" (Plan 4b) — ไม่งั้นรายชื่อกลายเป็น positional sym
