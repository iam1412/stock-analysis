...
const STEP_LABELS = {
  ...
  'test/report-values-test.js': ['📐', 'unit-test schema v2 (report-values-test)', 'report-values schema gate', { quiet: true, comment: '# schema v2 (report-data.values · dateEra BE/CE · token {{rd:...}}) — เจ้าของเดียวคือ tools/report-values.js\n# (ระยะ 2 ส่วน B) วางไว้ก่อน check-reports เพื่อให้ schema พังโผล่ก่อนกวาดทั้งคลัง' }],
