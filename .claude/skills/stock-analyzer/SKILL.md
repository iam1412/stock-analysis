...
- **สีแบรนด์** ใน `report-data.theme` เลือกตามลักษณะหุ้น ห้ามปล่อยน้ำเงิน default — เลือก hex ตาม `tools/brand-colors.md` แล้วทำตามสูตร 3 บรรทัด (makeTheme → theme → seeds.json) ใน `docs/templates.md` §"ตัวอย่าง filled (NEW)"
