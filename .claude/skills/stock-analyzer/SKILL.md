...
กติกา orchestration (เวฟ ≤3 / sequential / push per-wave / โมเดล / ห้าม Haiku) อยู่ `CLAUDE.md §3–5` + `docs/orchestration.md` — skill นี้คือ "ทำ 1 หุ้นให้ถูกและประหยัด token"
