...
// ── E34/W11/W12: ป้าย change + กราฟ (จากบั๊ก session มิ.ย. 2026: HMPRO/CPF สีผิด, กราฟไม่ตรงจริง) ──
// BBL ฐาน = "▲ +31% ในรอบปี" + theme เขียว (ขึ้น+เขียว = ถูก) → mutate ให้ผิดทิศ
expect('E34', 'error', (h) => h.replace('▲ +31% ในรอบปี', '▼ −31% ในรอบปี'), 'ป้าย change ขาลง (▼ −) แต่ theme ยังเขียว (เคส HMPRO/CPF) → ต้องจับ E34');
reject('E34', (h) => h.replace('▲ +31% ในรอบปี', '≈ ทรงตัว ในรอบปี'), 'ป้าย change "ทรงตัว" (ไม่มีทิศทาง) → ต้องไม่ฟ้อง E34');
expect('W11', 'warn', (h) => h.replace('▲ +31% ในรอบปี', '▲ +99% ในรอบปี'), 'headline +99% ขัดกับปลายกราฟ (~+30%) → เตือน W11');
reject('W11', (h) => h.replace('▲ +31% ในรอบปี', '▲ +99% (23 มิ.ย.)'), 'ป้าย change รายวัน (ไม่ใช่ "รอบปี") แม้ % ต่างจากกราฟ → ต้องไม่ฟ้อง W11');
